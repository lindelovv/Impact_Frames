...
public partial class GoInGameSystem : SystemBase
{
    ...
    protected override void OnCreate()
    {
        ...
        _networkId = GetComponentLookup<NetworkId>(true);
    ...
    protected override void OnUpdate()
    {
        ...
        Entities
            .WithName("NewConnectionsGoInGame")
            ...
            .ForEach((Entity ent, in NetworkId id) =>
            {
                ...
                cmdBuffer.AddComponent<NetworkStreamInGame>(ent);
                
                var player = cmdBuffer.Instantiate(spawner.Player);
                cmdBuffer.SetComponent(player, new GhostOwner { NetworkId = id.Value });
                cmdBuffer.SetComponent(player, spawner.SpawnPoint);
            }).Run();
